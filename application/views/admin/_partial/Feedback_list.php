...
<body>
	<main class="main">
		<?php $this->load->view('admin/_partial/side_nav.php') ?>
		...
		<div class="content">
			...
			<div class="card">
				<div class="card-header">
					<div>
						<b>Dian</b> <small class="text-gray">mandrake@petanikode.com</small>
					</div>
					<div><small class="text-gray">10 desember 2021</small></div>
				</div>
